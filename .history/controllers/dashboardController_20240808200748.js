...
const getSalesComparison = async (req, res) => {
  try {
    ...
    // Calculate the start and end dates for previous and current months
    const startOfPreviousMonth = new Date(currentYear, currentMonth - 1, 1); // Start of last month
    const endOfPreviousMonth = new Date(currentYear, currentMonth, 0, 23, 59, 59); // End of last month

    const startOfCurrentMonth = new Date(currentYear, currentMonth, 1); // Start of this month
    const endOfCurrentMonth = new Date(currentYear, currentMonth + 1, 0, 23, 59, 59); // End of this month

    // Fetch sales data for the previous and current months
    ...
    // Extract total sales from the fetched data
    const previousMonthTotalSales = previousMonthSales.length ? previousMonthSales[0].totalSales : 0;
    const currentMonthTotalSales = currentMonthSales.length ? currentMonthSales[0].totalSales : 0;
